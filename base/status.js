var main = {
    init: function(){
        ...
        let server_status_url = `base/proxy.php?u=info`;
        let players_list_url = `base/proxy.php?u=players`;
    ...
    get_server_status: function(server_status_url){
        fetch(
            ...
            document.getElementById('sv_maxClients').innerText = `Max Oyuncu: ${myJson.vars.sv_maxClients}`;
            ...
            document.getElementById('onesync_enabled').innerText = `OneSync: ${myJson.vars.onesync_enabled}`;
            ...
            document.getElementById('tags').innerText = `Tag: ${myJson.vars.tags}`;
            document.getElementById('locale').innerText = `Dil: ${myJson.vars.locale}`;
    ...
    get_players_list: function(players_list_url){
        fetch(
            ...
            document.getElementById('players_count').innerText = ` Online Oyuncular: ${myJson.length}`;
